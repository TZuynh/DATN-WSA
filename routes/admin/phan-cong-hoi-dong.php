...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::post('/admin/phan-cong-hoi-dong/replace-and-delete', [PhanCongHoiDongController::class, 'replaceAndDelete'])
    ->name('admin.phan-cong-hoi-dong.replace-and-delete');
});
