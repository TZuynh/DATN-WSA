    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('giangvien.de-tai.update', $deTai) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('y_kien_giang_vien') is-invalid @enderror" id="y_kien_giang_vien" name="y_kien_giang_vien" rows="3" placeholder="Nhập ý kiến của giảng viên">{{ old('y_kien_giang_vien', $deTai->y_kien_giang_vien) }}</textarea>
