            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.phan-cong-cham.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <tbody>
                                @forelse($phanCongChams as $phanCongCham)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($phanCongCham->ngay_phan_cong)->format('d/m/Y') }}</td>
                                        <td>
                                            ...
                                            <form action="{{ route('admin.phan-cong-cham.destroy', $phanCongCham) }}" 
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm" 
                                                        onclick="return confirm('Bạn có chắc chắn muốn xóa phân công chấm này?')">
