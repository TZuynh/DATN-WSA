...
@section('title', 'Chỉnh sửa thông tin lớp')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.lop.update', $lop) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="{{ route('admin.lop.index') }}" class="btn btn-secondary">Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
