        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Thêm mới đề tài mẫu</h3>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('admin.de-tai-mau.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('ten_de_tai') is-invalid @enderror" 
                                id="ten_de_tai" name="ten_de_tai" value="{{ old('ten_de_tai') }}" required>
                            @error('ten_de_tai')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('mo_ta') is-invalid @enderror" 
                                id="mo_ta" name="mo_ta" rows="3" required>{{ old('mo_ta') }}</textarea>
                            @error('mo_ta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('yeu_cau') is-invalid @enderror" 
                                id="yeu_cau" name="yeu_cau" rows="3" required>{{ old('yeu_cau') }}</textarea>
                            @error('yeu_cau')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('tai_lieu_tham_khao') is-invalid @enderror" 
                                id="tai_lieu_tham_khao" name="tai_lieu_tham_khao" rows="3" required>{{ old('tai_lieu_tham_khao') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('so_luong_sinh_vien') is-invalid @enderror" 
                                id="so_luong_sinh_vien" name="so_luong_sinh_vien" value="{{ old('so_luong_sinh_vien') }}" 
                                min="1" required>
